...
public class RecommendFolder extends RelativeLayout implements CanMergeView {
    ...
    private static final int FOLDER_ID = R.id.recommend_folder_bg;
    private static final int TAG_ID = R.id.recommend_folder_tag;
    private static final int CONTAINER_GRID_ID = R.id.recommend_folder_grid;
    private static final int CHECK_BOX_ID = R.id.recommend_folder_check_box;
    private static final int CONTENT_ID = R.id.recommend_folder_content;
    private PrimitiveSimpleAdapter mSimpleAdapter;
    private RecommendGridLayout mGridLayout;
    ...
    public RecommendFolder(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RecommendFolder(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RecommendFolder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void ensureViewFound() {
        if (mFolderBg == null | mContent == null | mTagView == null | mGridLayout == null) {
            ...
            mGridLayout = (RecommendGridLayout) findViewById(CONTAINER_GRID_ID);

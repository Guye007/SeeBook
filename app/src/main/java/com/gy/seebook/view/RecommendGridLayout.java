...
public class RecommendGridLayout extends ViewGroup {
    ...
    public RecommendGridLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecommendGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecommendGridLayout, defStyleAttr, 0);
        mRowCount = a.getInt(R.styleable.RecommendGridLayout_recommendRowCount, 2);
        mColumnCount = a.getInt(R.styleable.RecommendGridLayout_recommendColumnCount, 2);
        mGap = a.getDimensionPixelSize(R.styleable.RecommendGridLayout_recommendGap, 0);
        a.recycle();
    }
